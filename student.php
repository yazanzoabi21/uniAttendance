...
<div class="bg">
    <a href="addStudent.php">
        <img src="images/addStd.png" class="rounded float-start" alt="">
        <br><br>
        <div class="Atxt">
            Add Student
        </div>
    </a>
    <a href="ShowAllStudents.php">
        <img src="images/showstudent.png" class="rounded float-end" alt="">
        <br><br>
        <div class="Stxt">
            Show Students
        </div>
            ...
            <header>
                <h2>
                    <label for="nav-toggle">
                        <img src="images/graduated.png" width="40px" height="40px" alt="">
                    </label>
                    Student
                </h2>
