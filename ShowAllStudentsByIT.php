  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav m-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="ShowAllStudentsByIT.php">Show All Students</a>
        </li>
...
<p class="text-center fs-1">List Of Students</p>
  ...
  $result = mysqli_query($link, $query);
      ...
      echo '<div  class ="form" id="form">';
			...
			echo '<thead ><tr ><th>#</th> <th>Name</th><th>Last Name</th><th>Major</th><th>Email</th><th>Phone Number</th><th>Update</th></tr></thead>';
			while ($row = mysqli_fetch_assoc($result)){
				echo '<tr><td>' . $row['Student_id'] . '</td><td>' . $row['Name'] . '</td><td>' . $row['Last_Name'] . '</td><td>' . $row['major']. '</td><td>' . $row['Email']. '</td><td>' . $row['Phone']. '</td>'
        .'<td><a href="updatestudent.php?id='.$row['Student_id'].'"> <button class="btn btn-outline-secondary" type="submit"><img src="images/pencil-square.svg" style="width: 30px;" > </button>	';
